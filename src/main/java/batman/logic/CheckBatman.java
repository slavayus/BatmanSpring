...
public class CheckBatman {
    ...
    public void setGetZoom(double getZoom) {
        this.getZoom = getZoom;
    }

    public PointEntity updatePoint() {
        PointEntity pointEntity = new PointEntity();
        pointEntity.setX(getX / 7);
        pointEntity.setY(getY / 7);
        pointEntity.setZoom(getZoom);
        pointEntity.setInBatman(check());
        pointEntity.setCurrentTime(new Date());
        pointEntity.setProcessTime(System.nanoTime() - start);
        return pointEntity;
    }
}